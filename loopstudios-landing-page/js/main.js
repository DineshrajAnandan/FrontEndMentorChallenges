...
function registerEvents() {
    document.querySelector('.ham-menu.mobile').addEventListener('click', openMobileMenu);
    document.querySelector('.menu-close.mobile').addEventListener('click', closeMobileMenu)
}
...
function closeMobileMenu(el) {
    ...
    // document.querySelector('.ham-menu.mobile').style.display = 'block';
    // document.querySelector('.mobile-menu-overlay').classList.remove('visible');
    document.querySelector('.header-wrap > .menu-wrap').classList.remove('visible');
}
